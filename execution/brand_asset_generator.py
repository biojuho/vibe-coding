...
Usage:
    python execution/brand_asset_generator.py --channel "우주/천문학"
    python execution/brand_asset_generator.py --channel "요리" --bg-color "#1a0a2e"
"""
...
def generate_channel_brand(
    ...
    if output_dir is None:
        output_dir = _ROOT / "shorts-maker-v2" / "assets" / "channels" / channel
...
def _cli() -> int:
    ...
    parser.add_argument("--output-dir", default="", help="저장 경로 (기본: shorts-maker-v2/assets/channels/<channel>)")
