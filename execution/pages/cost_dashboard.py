...
_BTX_COST_DB = None
try:
    _btx_path = Path(__file__).resolve().parent.parent.parent / "blind-to-x" / "pipeline" / "cost_db.py"
...
_shorts_costs_file = Path(__file__).resolve().parent.parent.parent / "shorts-maker-v2" / "logs" / "costs.jsonl"
