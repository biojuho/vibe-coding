...
Usage:
    python execution/bgm_downloader.py
    python execution/bgm_downloader.py --query "calm ambient" --count 5
    python execution/bgm_downloader.py --output-dir shorts-maker-v2/assets/bgm
"""
...
def download_bgm(
    ...
    Args:
        ...
        count: 다운로드할 파일 수
        output_dir: 저장 경로 (기본: shorts-maker-v2/assets/bgm)
...
def _cli() -> int:
    ...
    parser.add_argument("--output-dir", default="", help="저장 경로 (기본: shorts-maker-v2/assets/bgm)")
