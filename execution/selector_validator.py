...
Usage (CLI):
    python execution/selector_validator.py            # 전체 검증
    python execution/selector_validator.py --site ppomppu  # 특정 사이트만
    python execution/selector_validator.py --json         # JSON 출력
...
def main() -> int:
    ...
    if not summary["healthy"]:
        print("\n  ⚠️  셀렉터 수정 필요 — blind-to-x/scrapers/ 확인")
