...
Usage:
    python execution/backup_restore_test.py           # 전체 검증 + Telegram 알림
    python execution/backup_restore_test.py --json    # JSON 출력만
    python execution/backup_restore_test.py --dry-run # 실제 복사 없이 경로만 확인
"""
