...
st.caption(
    "Fallbacks: " + ", ".join(policy["fallback_providers"]) + " | Strict Korean: " + str(policy["strict_korean"])
)
...
try:
    ...
    _btx_root = resolve_project_dir("blind-to-x", required_paths=("pipeline",)) / "pipeline" / "cost_db.py"
