...
사용 예시:
    python workspace/execution/notebooklm_integration.py research "AI trends 2026" --urls https://example.com
    python workspace/execution/notebooklm_integration.py generate-quiz "AI Research" --difficulty hard
    python workspace/execution/notebooklm_integration.py bulk-import "My Collection" --urls urls.txt
"""
