...
Usage:
    python workspace/execution/channel_growth_tracker.py init
    python workspace/execution/channel_growth_tracker.py add --channel-id "UCxxxx" --name "AI/기술"
    python workspace/execution/channel_growth_tracker.py collect
    python workspace/execution/channel_growth_tracker.py report
"""
