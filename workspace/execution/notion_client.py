...
Usage:
    python workspace/execution/notion_client.py list-tasks [--status "In Progress"]
    python workspace/execution/notion_client.py update-task --id PAGE_ID --status "Done"
    python workspace/execution/notion_client.py create-task --title "New Task" --status "To Do"
...
def create_task(title: str, status: str = "To Do", due_date: Optional[str] = None) -> Optional[str]:
