...
### CLI
```bash
python workspace/execution/community_trend_scraper.py                    # 전체 수집
python workspace/execution/community_trend_scraper.py --source fmkorea   # 에펨코리아만
python workspace/execution/community_trend_scraper.py --limit 5 --json   # JSON 출력
```
