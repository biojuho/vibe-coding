...
- **파일**: `projects/shorts-maker-v2/src/shorts_maker_v2/utils/style_tracker.py`, `projects/shorts-maker-v2/src/shorts_maker_v2/pipeline/render_step.py`
...
- **파일**: `projects/blind-to-x/pipeline/ml_scorer.py`, `projects/blind-to-x/pipeline/cost_db.py`

### T1-4. 크로스 프로젝트 성과 대시보드
- **현황**: blind-to-x, shorts-maker-v2 성과가 각각 분리 추적
- **작업**:
  1. `workspace/execution/pages/performance_overview.py` 신규: 통합 KPI 대시보드
  2. 지표: 일일 발행수, 플랫폼별 도달률, API 비용/콘텐츠당 비용, 트렌드 차트
  3. 데이터 소스: `result_tracker.db` + blind-to-x `cost_db` + shorts `cost_tracker`
- **파일**: `workspace/execution/pages/performance_overview.py` (신규)
...
- **파일**: `projects/shorts-maker-v2/src/shorts_maker_v2/pipeline/topic_validator.py` (신규)
...
- **파일**: `projects/blind-to-x/scrapers/base.py`, `workspace/execution/selector_validator.py`
...
- **파일**: `projects/shorts-maker-v2/src/shorts_maker_v2/utils/content_calendar.py`, `workspace/execution/topic_auto_generator.py`
...
- **작업**:
  ...
  4. Streamlit 페이지 연동
- **파일**: `workspace/execution/channel_growth_tracker.py` (신규), `workspace/execution/pages/channel_growth.py` (신규)
...
- **파일**: `workspace/execution/pages/roi_dashboard.py` (신규)

### T4-3. 콘텐츠 시리즈화 엔진
- **현황**: 개별 토픽 1회성 생산, 시리즈 연속성 없음
- **작업**:
  1. `projects/shorts-maker-v2/src/shorts_maker_v2/pipeline/series_engine.py` 신규
  2. 고성과 토픽 자동 감지 → 시리즈 후속편 제안 (Part 2, 3...)
  3. 시리즈 간 내러티브 연결 (이전 편 요약 인트로)
  4. 시리즈별 성과 추적 + 중단/계속 자동 판단
- **파일**: `projects/shorts-maker-v2/src/shorts_maker_v2/pipeline/series_engine.py` (신규)
...
- **파일**: `projects/blind-to-x/pipeline/x_analytics.py` (신규)
...
- **파일**: `projects/shorts-maker-v2/tests/unit/test_render_step.py`, `projects/shorts-maker-v2/tests/unit/test_edge_tts_timing.py`
