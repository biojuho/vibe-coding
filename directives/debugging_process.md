...
- (e) 주요 모듈별 디버깅 가이드(execution/, pages/, blind-to-x, shorts-maker-v2)
...
| 실행 스크립트가 에러를 뱉나? | 3계층 | `python execution/xxx.py` 직접 실행 |
...
- (b) **단독 실행 테스트**: `python execution/문제스크립트.py` 직접 실행
