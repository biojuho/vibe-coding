...
data_comparison_GeneRegulatory = {
    ...
    "mean": {
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (100, 137)": np.array(
            [138.6, 140.4, 126.4, 51.2, 72.1, 158.14, 215.4, 62.7, 51.2]
        ),
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (150, 329)": np.array(
            [293.4, 317.2, 261.0, 99.8, 106.6, 303.79, 347.2, 86.3, 109.0]
        ),
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (200, 507)": np.array(
            [449.8, 495.6, 397.4, 162.8, 219.8, 508.25, 481.8, 159.2, 158.8]
        ),
    },
    "std": {
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (100, 137)": np.array([3.5, 3.9, 2.4, 3.3, 6.2, 8.6, 13.8, 3.2, 3.3]),
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (150, 329)": np.array([2.9, 3.7, 2.2, 4.0, 5.4, 12.4, 19.3, 2.8, 6.4]),
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (200, 507)": np.array([1.1, 6.5, 8.8, 6.2, 13.4, 23.6, 7.0, 11.6, 12.6]),
    },
}
