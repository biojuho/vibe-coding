...
data_math_by_category = {
    ...
    "subtypes": ["Standard", "Nonstandard", "Heuristic"],
    "result": {
        ...
        "Number Theory": np.array(
            [0.441176471, 0.558823529, 0.529411765, 0.676470588, 0.823529412, 0.735294118, 0.852941177]
        ),
        ...
        "Nonstandard": np.array(
            [0.103448276, 0.482758621, 0.431034483, 0.620689655, 0.74137931, 0.672413793, 0.827586207]
        ),
        "Logic": np.array([0.034482759, 0.413793103, 0.448275862, 0.517241379, 0.620689655, 0.517241379, 0.75862069]),
        "Special Number": np.array(
            [0.172413793, 0.551724138, 0.413793103, 0.724137931, 0.862068966, 0.827586207, 0.896551724]
        ),
...
data_logic_by_category = {
    ...
    "colors": ["#DDF3DE", "#AADCA9", "#8BCF8B", "#F6CFCB", "#E9A6A1", "#FFF6CC", "#3775BA"],
    "subtypes": ["Simple/large", "Complex/small", "Math-like", "Heuristic"],
    "result": {
        "Simple/large": np.array(
            [0.042105263, 0.178947368, 0.189473684, 0.389473684, 0.410526316, 0.515789474, 0.694736842]
        ),
        ...
        "Math-like": np.array(
            [0.085714286, 0.328571429, 0.371428571, 0.514285714, 0.542857143, 0.542857143, 0.714285714]
        ),
        "Algorithm": np.array(
            [0.078947368, 0.315789474, 0.368421053, 0.473684211, 0.447368421, 0.473684211, 0.710526316]
        ),
