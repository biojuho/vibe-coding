...
class RedliningValidator:
    ...
    def validate(self):
        ...
        try:
            ...
            sw_del_elements = [
                elem for elem in del_elements if elem.get(f"{{{self.namespaces['w']}}}author") == "Scientific-Writer"
            ]
            sw_ins_elements = [
                elem for elem in ins_elements if elem.get(f"{{{self.namespaces['w']}}}author") == "Scientific-Writer"
            ]
