...
| T-176 | [`blind-to-x`] Feed `반려 사유` / `위험 신호` data into the feedback loop. | Gemini | 2026-04-09 |
| T-174 | [code-review-graph P2] Validate `IMPORTS_FROM` edges for `hanwoo-dashboard` JS indexing. | Gemini | 2026-04-09 |
| T-173 | [code-review-graph P2] Install Google Embeddings support for `code-review-graph`. | Gemini | 2026-04-09 |
| T-167 | [ADR-026 Phase 3] Create `execution/ai_batch_runner.py` for async AI batch execution. | Gemini | 2026-04-09 |
