...
| T-147 | Create `hanwoo-dashboard` outbox worker script that consumes pending events and refreshes read-model snapshots. | Codex | Med | 2026-04-05 |

## IN_PROGRESS

| ID    | Task                                                                                                                                                                                                                                 | Owner | Started    | Notes |
|-------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|------------|-------|
| T-129 | Scale-harden `hanwoo-dashboard` for 100x traffic: cached read models, pagination, and client refactoring.                                                                                                                            | Codex | 2026-04-02 | Outbox events wired into 5 mutations, market price cache-through, notification read-model fallback. Next: outbox worker. |
...
|-------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------|
| T-120 | Fix `workspace/tests/test_auto_schedule_paths.py::test_n8n_bridge_defaults_use_canonical_paths` by letting `infrastructure/n8n/bridge_server.py` helper imports work without FastAPI installed. | Codex | 2026-04-05 |
