...
|-------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|----------|------------|
| T-159 | Harden the `hanwoo-dashboard` weather fetch path in `DashboardClient` so timeouts and shape drift degrade cleanly instead of silently breaking the widget. | Codex | High | 2026-04-07 |
