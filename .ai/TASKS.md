...
|---|---|---|---|
| T-168 | `projects/knowledge-dashboard/CLAUDE.md` 신규 생성 (스택, 검증 커맨드, ADR-023 인증, 지뢰밭 포함) | Gemini | 2026-04-09 |
...
| T-171 | [code-review-graph P0] 설치, blind-to-x + shorts-maker-v2 그래프 빌드, MCP 서버 연동 완료 | Gemini | 2026-04-09 |
