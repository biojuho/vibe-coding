...
| Next Priorities | Commit/push T-1241, comment on and close PR #115 as superseded, then confirm main `root-quality-gate` and `active-project-matrix`. Remaining open ESLint lines are expected to be Knowledge PR #117 and Hanwoo PR #122; T-251 remains user-owned Supabase credential reset. |
