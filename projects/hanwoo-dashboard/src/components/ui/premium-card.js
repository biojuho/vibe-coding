	...
	return (
		<PremiumCard>
			...
			<div
				...
				style={{
					background:
						"radial-gradient(ellipse at top left, color-mix(in srgb, var(--color-primary-light) 8%, transparent) 0%, transparent 60%)",
				}}
			/>
				...
				<div className="flex items-end justify-between gap-3">
					...
					{change && (
						<div
							...
							style={{
								color: isPositive
									? "var(--premium-card-badge-positive-text)"
									: "var(--premium-card-badge-negative-text)",
								background: isPositive
									? "var(--premium-card-badge-positive-bg)"
									: "var(--premium-card-badge-negative-bg)",
