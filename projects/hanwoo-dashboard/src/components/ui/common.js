...
export const btnDanger={
  ...
  border:"1px solid color-mix(in srgb, var(--color-danger) 28%, white 72%)",
  borderRadius:"var(--radius-md)",
  padding:"12px 20px",
  fontSize:"14px",
  fontWeight:600,
...
export const HeartIcon=()=><svg width="16" height="16" viewBox="0 0 24 24" fill="var(--color-estrus)" stroke="var(--color-estrus)" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>;
