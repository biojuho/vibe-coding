  ...
  const items = [
    {
      id: 'farm-profile',
      title: '농장 기본 정보',
      detail: hasText(farmSettings?.name) && hasText(farmSettings?.location)
    ...
    },
    {
      id: 'cattle',
      title: '개체 등록',
      detail: countItems(cattleList) > 0
    ...
    },
    {
      id: 'inventory',
      title: '재고 기준',
      detail: countItems(inventoryList) > 0
    ...
    },
    {
      id: 'schedule',
      title: '첫 일정',
      detail: countItems(scheduleEvents) > 0
