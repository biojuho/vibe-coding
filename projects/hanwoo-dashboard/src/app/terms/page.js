...
const sections = [
	...
	},
	{
		...
		body: [
			'서비스는 가입 후 14일간 무료 체험(이하 "체험 기간")을 제공합니다. 체험 기간 중 카드 등록은 불필요합니다.',
			"체험 기간 이후 서비스를 계속 이용하려면 월 9,900원의 구독을 결제해야 합니다. 결제는 토스페이먼츠(주)를 통해 처리됩니다.",
			"구독은 자동 갱신되지 않으며, 결제 완료 시점부터 30일간 유효합니다. 만료 후 계속 이용하려면 다시 결제해야 합니다.",
			"구독 해지는 언제든지 설정에서 가능합니다. 해지 즉시 프리미엄 기능 이용이 중단되며, 이미 결제된 기간에 대한 환불은 제공되지 않습니다.",
		],
	},
	{
		title: "문의처",
