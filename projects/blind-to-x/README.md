...
현재 기본 운영 모델은 `자동 수집 + 수동 검토 + 수동 발행`입니다. X 자동 발행은 선택 사항이며, 기본 전제는 아닙니다.
...
3. 괜찮은 항목만 `승인됨`으로 바꾸고 초안을 편집합니다.
4. 실제 발행은 사람이 수동으로 진행합니다.
...
X 자동 발행은 현재 기본 운영 범위가 아니므로, Twitter 키가 없어도 정상 운영할 수 있습니다.
