...
EMOTION_LEXICON: dict[str, list[str]] = {
    ...
    "웃김": ["웃김", "개웃", "현웃", "웃겨", "유머", "짤", "ㅋㅋ", "웃프", "코미디", "빵터", "ㅎㅎ"],
    ...
    "현타": [
        ...
        "퇴사",
        "현생",
    ],  # 퇴사(블라인드 핵심 키워드), 현생(현재 삶에 치임)
    "불안": ["불안", "걱정", "고민", "두렵", "막막", "초조", "스트레스", "압박", "답답", "공황"],
    "희망": ["희망", "기대", "설렘", "좋겠", "드디어", "성장", "합격", "축하"],
    "분석": ["분석", "정리", "비교", "종합", "트렌드", "팁", "방법", "가이드"],
    "연대": ["응원", "힘내", "파이팅", "함께", "우리", "같이", "동료", "선배"],
    # 블라인드·fmkorea 사이다 게시물 전용 — 억울함이 풀릴 때의 쾌감
    "통쾌": [
        "사이다",
        "속시원",
        "통쾌",
