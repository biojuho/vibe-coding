...
class DraftQualityGate:
    ...
    def _add_vague_expression_check(self, result: QualityResult, text: str) -> None:
        ...
        vague_patterns = [
            ...
            (r"여러 가지", "구체적으로 나열하세요"),
            # editorial.yaml cliche_watchlist 동기화 — 해설형 관료체 표현
            (r"흥미로운 점은", "직접 장면이나 팩트로 시작하세요"),
            (r"주목할 만한", "무엇이 주목할 만한지 구체적으로 써주세요"),
            (r"시사하는 바가", "해석을 직접 한 문장으로 써주세요"),
            (r"눈여겨볼 점은", "바로 핵심을 말하세요"),
            (r"진정한 의미의", "불필요한 수식어를 제거하세요"),
            (r"새로운 시대의", "어떤 시대인지 구체적으로 써주세요"),
            (r"변화의 바람이", "어떤 변화인지 수치나 장면으로 써주세요"),
            (r"핵심은 바로", "수식어 없이 바로 핵심을 말하세요"),
            (r"너무하다 싶네요", "판단 대신 팩트로 독자가 판단하게 두세요"),
            (r"솔직히 좀 그렇네요", "감상 대신 구체적 상황을 묘사하세요"),
        ]
        vague_found = []
