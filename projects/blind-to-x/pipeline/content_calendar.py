...
class ContentCalendar:
    ...
    def should_post_topic(
        ...
        if topic_cluster:
            same_topic_count = sum(1 for p in recent if p["topic_cluster"] == topic_cluster)
        ...
        if hook_type:
            ...
            same_hook = sum(1 for p in recent[:lookback] if p["hook_type"] == hook_type)
        ...
        if emotion_axis:
            ...
            same_emotion = sum(1 for p in recent[:lookback] if p["emotion_axis"] == emotion_axis)
