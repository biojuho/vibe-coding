...
class ScriptReviewMixin:
    ...
    _REVIEW_COPY: dict[str, str] = {
        "base_review_system": (
            ...
            "  cta_score  : How well does the closing land as a quiet, lingering thought? "
            "(1=abrupt or commanding CTA-style ending, 10=memorable afterimage with no action demands)\n"
